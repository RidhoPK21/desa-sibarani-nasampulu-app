class ApbdesModel {
  ...
  // --- PENAMBAHAN KALKULASI FALLBACK ---
  double get calculatedTotalPendapatan =>
      pendapatanAsliDesa +
          danaDesa +
          alokasiDanaDesa +
  ...
  double get calculatedTotalBelanja =>
      siltapKepalaDesa +
          siltapPerangkatDesa +
  ...
  // Memprioritaskan totalPendapatan/totalBelanja jika ada nilainya,
  // jika null, otomatis pakai calculatedTotal
  double get surplusDefisit =>
      (totalPendapatan ?? calculatedTotalPendapatan) -
          (totalBelanja ?? calculatedTotalBelanja);
  // -------------------------------------
